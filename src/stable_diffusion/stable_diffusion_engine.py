...
class StableDiffusionEngine:
    def __init__(
        self,
        scheduler,
        model="stable-diffusion-v1-4-openvino",
        ...
        self._text_encoder = self.core.read_model(
            f"{model}/text_encoder.xml",
            f"{model}/text_encoder.bin"
        )
